...
describe('redact', () => {
  ...
  it('redacts connection strings', () => {
    expect(redact('postgres://user:password@host:5432/db')).toBe('postgres://[REDACTED]');
    expect(redact('mongodb://admin:secret@cluster.mongodb.net/mydb')).toBe('mongodb://[REDACTED]');
  });
